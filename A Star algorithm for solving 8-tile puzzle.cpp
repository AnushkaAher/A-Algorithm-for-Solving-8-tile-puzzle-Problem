...
Difference in vertical + difference in horizontal i.e Manhattan Distance we are not using misplaced tiles
*/
...
//function to check whether we reached to the goal state or not
...
//A function to check whether give input is solvaable or not
